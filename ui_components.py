...
<div style="background:{C['surface']};border:1px solid {C['border']};
    ...
    <div style="display:flex;justify-content:space-between;align-items:flex-start;margin-bottom:10px;gap:12px;">
        <div>
            ...
            <div style="font-size:0.95rem;font-weight:700;color:{C['text']};line-height:1.3;">{insight.get('title', '')}</div>
        </div>
    ...
    <div style="font-size:1.05rem;font-weight:700;color:{fg};margin-bottom:8px;line-height:1.2;">{insight.get('metric', '')}</div>
    <div style="font-size:0.85rem;color:{C['text_body']};margin-bottom:10px;line-height:1.55;">{insight.get('forecast', '')}</div>
    <div style="border-top:1px solid {C['border']};padding-top:10px;
        ...
        <div style="font-size:0.8rem;color:{C['blue']};line-height:1.4;flex:1;">
            <strong>Recommended action:</strong> {insight.get('recommendation', '')}
        </div>
